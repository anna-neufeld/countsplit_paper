setwd("~/Dropbox/Pseudotime : PCA NEW/Paper/FinalCode/OverdispSims/overdispres_pt")
file_names <- dir("~/Dropbox/Pseudotime : PCA NEW/Paper/FinalCode/OverdispSims/overdispres_pt", pattern="Feb2*") #where you have your files
file_names <- file_names[201:249]
...
ggsave("~/Dropbox/Pseudotime : PCA NEW/Paper/paper_v16/Figures/overdisp_new.png",
       width=13, height=4)
